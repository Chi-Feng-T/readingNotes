...
> * 關於這一點，就我看來，又是一個在 ExtractMethod 與 InlineMethod 之間權衡的議題。再擴展到類別/模組/元件層面的話，要考量的事情又更多了。與 OCP 相關的經驗法則很重要、對 Domain/需求的分析理解很重要；實務上應消弭的重複是極常見的技術債務，專案管理上的權衡也很重要。
